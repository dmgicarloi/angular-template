    ...
    function ($window, $timeout) {
        return {
            ...
            link: function (scope, elem, attr) {
                ...
                scope.size = scope.size || 'none';
                scope.position = scope.position || 'none';

                var bgObj = elem[0];
                bgObj.style.minHeight = "200px";
                ...
                bgObj.style.backgroundSize = scope.size;
                bgObj.style.backgroundPosition = scope.position;
